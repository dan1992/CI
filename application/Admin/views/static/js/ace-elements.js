...
(function(e, c) {
	...
	f.prototype.apply_settings = function() {
		...
		this.$element.after(
				...
				+ this.settings.btn_choose + '"><span class="file-name" data-title="' 
		...
		console.log(k);
		if (k) {console.log(ace.click_event);
	...
	var g = function() {
			...
			e(k).on("dragenter", function(m) {
				...
				var m = true;
				console.log(l.settings.before_change);
