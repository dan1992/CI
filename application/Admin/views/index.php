<?php include_once set_realpath('public/header.php');?>
	<body>
		<?php include_once set_realpath('public/navbar.php');?>
		...
		<div class="main-container" id="main-container">
			...
			<div class="main-container-inner">
				...
				<?php include_once set_realpath('public/sidebar.php');?>
		...
		<?php include_once set_realpath('public/footer.php');?>
